...
export default function AppError({
  ...
  return (
    <div className="flex items-center justify-center min-h-[calc(100vh-56px)] p-8 bg-gray-50">
      <div className="max-w-lg w-full bg-white rounded-2xl shadow-md border border-red-100 p-8 space-y-4">
        ...
        <pre className="text-sm text-red-700 bg-red-50 rounded-xl p-4 whitespace-pre-wrap break-words font-mono">
          {error.message}
        </pre>
